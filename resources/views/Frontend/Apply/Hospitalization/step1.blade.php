    ...
    <div class="container">
        <div class="card text-light mt-5">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="needs-validation" action="{{url("/step3/data/hospitalization")}}" method="post" novalidate
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <textarea name="nature_of_illness" class="form-control" rows="5"
                                              placeholder="Player Details">{{old('nature_of_illness')}}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <textarea name="typeofsurgerie" class="form-control" rows="5"
                                              placeholder="Player Details">{{old('typeofsurgerie')}}</textarea>
